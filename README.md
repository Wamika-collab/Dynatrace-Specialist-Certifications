...
```mermaid
flowchart TD
    A[Prerequisite: Dynatrace Associate] --> B[Application Security Specialist]
    A --> C[Digital Experience Management DEM Specialist]
    A --> D[Cloud & Kubernetes Observability Specialist]

    style A fill:#002B49,stroke:#73BE28,stroke-width:2px,color:#FFF
    style B fill:#1A3B5C,stroke:#00A4E4,stroke-width:1px,color:#FFF
    style C fill:#1A3B5C,stroke:#00A4E4,stroke-width:1px,color:#FFF
    style D fill:#1A3B5C,stroke:#00A4E4,stroke-width:1px,color:#FFF
```
